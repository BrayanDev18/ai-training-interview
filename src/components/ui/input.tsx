...
// Convertimos la función en un componente con forwardRef
const ForwardedInput = React.forwardRef(Input) as <T extends FieldValues>(
  props: FormFieldProps<T> & { ref?: React.Ref<HTMLInputElement> }
